...
exports.swiftOptions = {
    ...
    useDefaultValue: new RendererOptions_1.BooleanOption("use-default-value", "set default value, some type not support", false),
...
class SwiftTargetLanguage extends TargetLanguage_1.TargetLanguage {
    ...
    getOptions() {
        return [
            ...
            exports.swiftOptions.useDefaultValue
        ];
    }
...
class SwiftRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    swiftDefautValue(t) {
        return TypeUtils_1.matchType(t, _anyType => {
            ...
            return "nil"
        }, _boolType => "false", _integerType => "0", _doubleType => ".0", _stringType => "\"\"", arrayType => ["[]"], mapType => "[:]", classType => this.nameForNamedType(classType), enumType => this.nameForNamedType(enumType), unionType => {
            return ""
    ...
    propertyLinesDefinition(name, parameter) {
        ...
        const useDefaultValue = this._options.useDefaultValue;
        return [this.accessLevel, useMutableProperties ? "var " : "let ", name, ": ", this.swiftPropertyType(parameter),  useDefaultValue? " = " : "", useDefaultValue ? this.swiftDefautValue(parameter.type) : ""];
    }
